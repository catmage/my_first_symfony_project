 ...
 */
class getCommercialDepartmentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommercialDepartmentRepository' shared autowired service.
     *
     * @return \App\Repository\CommercialDepartmentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommercialDepartmentRepository.php';

        return $container->privates['App\\Repository\\CommercialDepartmentRepository'] = new \App\Repository\CommercialDepartmentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
