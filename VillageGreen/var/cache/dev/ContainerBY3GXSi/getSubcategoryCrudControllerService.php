...
class getSubcategoryCrudControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'Admin'.\DIRECTORY_SEPARATOR.'SubcategoryCrudController.php';
        ...
        $instance->setContainer(($container->privates['.service_locator.Jaz8VFM'] ?? $container->load('get_ServiceLocator_Jaz8VFMService'))->withContext('App\\Controller\\Admin\\SubcategoryCrudController', $container));
